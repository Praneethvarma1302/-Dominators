...
def mainroot(login_user_id):
	...
	def profile_information():
		...
		#--------------------------------------------------------right side---------------------------------------------------
		# Label(b_frame,text='Personal Info',font='msserif 20',bg='gray93').place(x=850,y=0)
		...
		# Label(b_frame,text='Name :',bg='gray93',font='15').place(x=730,y=50)
		# name = Entry(b_frame, font='msserif 14')
		# name.insert(0, x[1])
		# name.place(x=830,y=50)
		# name.configure(state='readonly')
		

		# Label(b_frame,text='Email :',bg='gray93',font='15').place(x=730,y=80)
		# email = Entry(b_frame, font='msserif 14')
		# email.insert(0, x[2])
		# email.place(x=830,y=80)
		# email.configure(state='readonly')


		# Label(b_frame,text='Phn No :',bg='gray93',font='15').place(x=730,y=110)
		# phn = Entry(b_frame, font='msserif 14')
		# phn.insert(0, x[3])
		# phn.place(x=830,y=110)
		# phn.configure(state='readonly')

		# Label(b_frame,text='Gender :',bg='gray93',font='15').place(x=730,y=140)
		# var = StringVar()
		# var.set(str(x[4]))
		# male_rb = Radiobutton(b_frame, text='Male',bg='#CCCCCC',variable=var,value='male',font=('Times', 10),width=3)
		# male_rb.place(x=830,y=140)
		# female_rb = Radiobutton(b_frame,text='Female',bg='#CCCCCC',variable=var,value='female',font=('Times', 10),width=3)
		# female_rb.place(x=880,y=140)
		# others_rb = Radiobutton(b_frame,text='Others',bg='#CCCCCC',variable=var,value='others',font=('Times', 10),width=3)
		# others_rb.place(x=930,y=140)
		...
		# editDetails_btn = Button(b_frame,text='Edit',bg='white',relief='sunken',fg='cyan4',font='timenewroman 9',activebackground='green',command = editDetails)
		# editDetails_btn.place(x=830,y=175)
	...
	def rooms():
		...
		def roomdet(rno):
			...
			e = Entry(smf2,fg='cyan4',bg='white',font='msserif 35')
			e.insert(0,str(rdata[0][5]))
	...
	def payments():
		...
		#l1.pack()
			...
			#print (idd)
	#cur.execute("create table if not exists bookings(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar,totalamt varchar)")
			cur.execute("select * from payments where id = ?",(idd,))
			x = cur.fetchall()
			#print(x)
			cur.execute("select day,month,year,time,totalamt,r_n from bookings where id = ?",(idd,))
			yy = cur.fetchone()
			print (yy)
			#print (x)
			if(yy!=None):
